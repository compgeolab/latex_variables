...
from latex_variables.version import full_version
...
sphinx_gallery_conf = {
    ...
    "doc_module": "latex_variables",
    # Insert links to documentation of objects in the examples
    "reference_url": {"latex_variables": None},
}
...
project = "LaTeX Variables"
copyright = "2021 Santiago Soler"
...
html_context = {
    ...
    "menu_links": [
        ...
        (
            ...
            "https://github.com/fatiando/latex_variables/blob/master/CONTRIBUTING.md",
        ),
        (
            '<i class="fa fa-gavel fa-fw"></i> Code of Conduct',
            "https://github.com/fatiando/latex_variables/blob/master/CODE_OF_CONDUCT.md",
        ),
        ('<i class="fa fa-comment fa-fw"></i> Contact', "http://contact.fatiando.org"),
        (
            '<i class="fa fa-github fa-fw"></i> Source Code',
            "https://github.com/fatiando/latex_variables",
        ),
    ],
    ...
    "github_repo": "fatiando/latex_variables",
